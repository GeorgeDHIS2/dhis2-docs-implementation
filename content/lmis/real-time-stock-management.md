...
## Overview of the DHIS2 Real-Time Stock Management Tool (DHIS2-RTS)
...
Please refer to Android Implementation guidelines:
...
##### DHIS2-RTS Daily report - Details
...
Data element represents the various transactions which affect the Stock on hand calculations (receipt, distributions, corrections etc.)

The "Deliver to" Data element uses the "Deliver to" Option Set which lists the names of the different departments Tracked entity attribute The item attributes are Item code, description and the barcode (field for scanning) Tracked entity type The item (health care product) is tracked
...
#### Metadata for "aggregate" Data entry form
...
>>1.4 Category option combination
>
>**2 DATA ELEMENT**  
>>2.1 Data element
> 
...
>>4.2 Organisation unit group 
>>4.3 Organisation unit group set
>>4.4 Organisation unit level
>>4.5 Hierarchy options
>
>**5 PREDICTOR**  
>>5.1 Predictor
>>5.2 Predictor group
...
>>"DIS - "Steril. Dep."  
>>"DIS - "Transf. services"  
>>"DIS - "Stock distribution"  
>>"DIS - "Stock discard"  
>>"DIS - "Stock correction"  
>>"DIS - "Stock on hand"  
>>"DIS - "Stock on hand Yes/No"  
>
...
>>**Categories**: "RTS - Daily stock report"  
>
>**2 RTS - Monthly stock report**
>>**Name \(*)**: ""RTS - Monthly stock report""  
>>**Data dimension type \(*)**: "Disaggregation"  
...
### 2 DATA ELEMENT
#### 2.1 Data element"
>**1 Data elements for RTS - Daily stock report**  
One Date element is created for every item (healthcare product)
>>**Name \(*)**: "[Item description] - T2A DLY"  
>>**Short name \(*)**: "[Item description] - T2A DLY"  
>>**Domain Type \(*)**: "Aggregate"  
>>**Value type \(*)**: "Positive or Zero integer"  
>>**Aggregation type (*)**: "Sum"  
>>**Store zero data values**: tag  
>>**Category combination \(*)**: "RTS - Daily stock report"  
>
>**2 Data elements for RTS - Monthly stock report**  
One Date element is created for every item (healthcare product)
>>**Name \(*)**: "[Item description] - T2A MTH"  
>>**Short name \(*)**: "[Item description] - T2A MTHY"  
>>**Domain Type \(*)**: "Aggregate"  
>>**Value type \(*)**: "Positive or Zero integer"  
>>**Aggregation type (*)**: "Sum"  
>>**Store zero data values**: tag  
...
>>**Period type**: "Daily"  
>>**Category combination**: "None"  
>>**Data elements**: Add all Data elements "[Item description] - T2A DAY"  
>>**Organisation units selected**: (select as for the Tracker Program) 
>
>**2 RTS Monthly report**  
>>**Name \(*)**: "RTS Monthly report"  
>>**Short name \(*)**: "RTS Monthly report"  
>>**Expiry days**: "1"  
>>**Open future periods for data entry**: "1"  
...
>>**Period type**: "Daily"  
>>**Category combination**: "None"  
>>**Data elements**: Add all Data elements "[Item description] - T2A MTH"  
>>**Organisation units selected**: (select as for the Tracker Program) 
>

### 4 ORGANISATION UNIT
#### 4.1 Organisation unit
Use existing Organisation Units and/or configure according to national protocols and policies.
...
## DHIS2-RTS Integration with National eLMIS
